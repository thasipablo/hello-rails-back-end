...
- [📖 \[Hello Rails React React backend\] ](#-hello-rails-react-react-backend-)
...
This application is a simple Ruby and Rails project that shows how to set up an API rails that can interact with a front-end client. 
[Link to the frondend application repository](https://github.com/thasipablo/hello-react-front-end)
...
```sh
  git git@github.com:thasipablo/hello-rails-back-end.git
